...
import com.college.classtrackingsystem.RequestExtraClassActivity
class FacultyDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cardExtraClass = findViewById<CardView>(R.id.cardExtraClass)
        cardExtraClass.setOnClickListener {
            val intent = Intent(this, RequestExtraClassActivity::class.java)
